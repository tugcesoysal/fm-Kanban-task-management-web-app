...
const DeleteBoardModal = () => {
  ...
  return (
    <div className=" fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[343px] sm:w-[480px] bg-white dark:bg-darkGrey rounded-md p-8 flex flex-col gap-6 shadow-lg z-40">
